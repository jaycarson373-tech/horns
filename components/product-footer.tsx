  ...
  return (
    <footer className="product-footer">
      <div className="footer-meta">
        ...
        <nav><Link href="/xbt">Agent</Link><Link href="/signals">Calls</Link><Link href="/callers">Callers</Link><Link href="/terminal">Terminal</Link><Link href="/treasury">Treasury</Link><Link href="/docs">Docs</Link>{botHandle ? <a href={`https://x.com/${botHandle}`} target="_blank" rel="noreferrer">X ↗</a> : null}</nav>
